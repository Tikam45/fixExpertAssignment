  ...
  export default function WashingMachinePage({city}: {city: keyof typeof address.locations}) {
      ...
      <>ht
            ...
            <div className="breadcrumb-content border">
              <div className="breadcrumb-content-item">
                <h2 className="fw-semibold display-5 text-center">
                  Washing Machine <span className="gradient-text">Service in  </span>
                </h2>
        ...
        <div className="container">
            <div className="text-center mb-5">
                ...
                <p className="text-custom-light">Expert Repair & Maintenance for All Leading Washing Machine Brands</p>
            </div>
                ...
                <div className="col-6 col-md-3">
                    <div className="brand-service">
                        <a href="lg-washing-machine-service-centre.html">
                            <img src="images/album/brands/lg.svg" width="100%" height="100%" alt="lg Washing Machine service center"/>                        </a>
                    ...
                    <div className="brand-service">
                        <a href="samsung-washing-machine-service-centre.html">
                            <img src="images/album/brands/samsung.svg" width="100%" height="100%"
                                alt="samsung Washing Machine service center"/>                        </a>
                        <a className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
                            href="">Samsung</a>
                    </div>
                </div>
                    ...
                    <div className="brand-service">
                        <a href="onida-washing-machine-service-centre.html">
                            <img src="images/album/brands/onida-logo.png" width="100%" height="100%"
                                alt="onida Washing Machine service center"/>                        </a>
                        <a className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
                            href="">Onida</a>
                    </div>
                </div>
                    ...
                    <div className="brand-service">
                        <a href="panasonic-washing-machine-service-centre.html">
                            <img src="images/album/brands/panasonic-logo.webp" width="100%" height="100%"
                                alt="panasonoic Washing Machine service center"/>                        </a>
                        <a className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
                            href="">Panasonic</a>
                    </div>
                </div>
                    ...
                    <div className="brand-service">
                        <a href="haier-washing-machine-service-centre.html">
                            <img src="images/album/brands/Haier.svg" width="100%" height="100%"
                                alt="haier Washing Machine service center"/>                        </a>
                        <a className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
                            href="">Haier</a>
                    </div>
                </div>
                    ...
                    <div className="brand-service">
                        <a href="whirlpool-washing-machine-service-centre.html">
                            <img src="images/album/brands/whirlpool.svg" width="100%" height="100%"
                                alt="whirlpool Washing Machine service center"/>                        </a>
                        <a className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
                            href="">Whirlpool</a>
                    </div>
                </div>
                <div className="col-6 col-md-3">
                    <div className="brand-service">
                        <a href="godrej-washing-machine-service-centre.html">
                            <img src="images/album/brands/godrej.svg" width="100%" height="100%"
                                alt="godrej Washing Machine service center"/>                        </a>
                        <a className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
                            href="">Godrej</a>
                    </div>
                </div>
                <div className="col-6 col-md-3">
                    <div className="brand-service">
                        <a href="ifb-washing-machine-service-centre.html">
                            <img src="images/album/brands/ifb-logo.svg" width="100%" height="100%"
                                alt="IFB Washing Machine service center"/>                        </a>
                        <a className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
                            href="">IFB</a>
                    </div>
                </div>
                <div className="col-6 offset-md-4 col-md-3">
                    <div className="brand-service">
                        <a href="bosch-washing-machine-service-centre.html">
                            <img src="images/album/brands/bosch.svg" width="100%" height="100%"
                                alt="Bosch Washing Machine service center"/>                        </a>
                        <a className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
                            href="">Bosch</a>
                    </div>
                </div>
    ...
    <section className="our-service-includes my-9">
        <div className="container">
            <div className="text-center mb-5">
                <div className="w-100 d-flex align-items-center justify-content-center">
                    <h6 className="text-primary text-uppercase section-title">Our Washing Machine Services Include</h6>
                </div>
                <h2 className="fw-bold display-5 section-subtitle">
                    Comprehensive Solutions for <br />All Your <span className="gradient-text">Washing Machine</span> Needs
                </h2>
                <p className="text-custom-light">At EasyFix Expert, we offer a full range of professional Washing Machine
                    services to ensure your home or business stays cool and comfortable throughout the
                    year. From installation and repairs to routine maintenance, our expert technicians are equipped to
                    handle all your washing machine needs. No matter the brand or model, we deliver fast, reliable, and affordable
                    service.</p>
            </div>
                    ...
                    <div className="card h-100">
                        <div className="card-body">
                            <span className="check-mark">
                                <img src="images/album/ion--location-sharp.svg" height="28" width="28" alt="location-icon"/>                            </span>
    ...
    <section className="our-service-includes my-10">
        <div className="container">
            <div className="text-center mb-5">
                ...
                <h2 className="fw-bold display-5 section-subtitle">
                    Washing Machine Repair Services Across <br /><span className="gradient-text">Various Regions</span> and Nearby Areas
                </h2>
                <p className="text-custom-light">At srikk service centre, we offer a full range of professional air
                    conditioning services to ensure your home or business stays cool and comfortable throughout the
                    year. From installation and repairs to routine maintenance, our expert technicians are equipped to
                    handle all your Washing Machine needs. No matter the brand or model, we deliver fast, reliable, and affordable
                    service.</p>
            </div>
        ...
        <div className="booking-form p-4 w-100 w-md-50 mx-auto bg-white rounded-4">
            ...
            <form id="submit-to-google-sheet">
                ...
                <div className="mb-3">
                    ...
                    <input type="tel" name="phone" className="form-control" id="phone" pattern="[0-9]{10}"
