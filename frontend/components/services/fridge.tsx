...
export default function FridgePage({city}: {city: keyof typeof address.locations}) {
    ...
    return (
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="p-3 p-md-5 custom-bg custom-border-radius">
                ...
                <p>
                  Are you facing issues with your refrigerator? Whether it’s a minor repair, routine
                  maintenance, or a major breakdown, we are here to provide expert solutions for all
                  your refrigeration needs. Our skilled technicians offer top-notch refrigerator repair,
                  installation, and servicing for both residential and commercial spaces.
                </p>
      ...
      <section className="brands-we-service my-9">
        <div className="container">
            <div className="text-center mb-5">
                ...
                <h2 className="fw-bold display-5 section-subtitle">
                    refrigerator <span className="gradient-text">Brands</span> We Service
                </h2>
                <p className="text-custom-light">Expert Repair & Maintenance for All Leading refrigerator Brands</p>
            </div>
      ...
      <section className="our-service-includes my-9">
          <div className="container">
              <div className="text-center mb-5">
                  <div className="w-100 d-flex align-items-center justify-content-center">
                      <h6 className="text-primary text-uppercase section-title">Our Refrigerator Services Include</h6>
                  </div>
                  <h2 className="fw-bold display-5 section-subtitle">
                      Comprehensive Solutions for <br />All Your <span className="gradient-text">Refrigerator</span> Needs
                  </h2>
                  <p className="text-custom-light">At EasyFix Expert, we offer a full range of professional Refrigerator
                      ...
                      handle all your Refrigerator needs. No matter the brand or model, we deliver fast, reliable, and
                      affordable
                      service.</p>
              </div>
                  ...
                  <div className="col">
                      ...
                      <div className="card h-100">
                          <div className="card-body">
                              ...
                              <h5 className="card-title m-0">
                                  Refrigerator unit gas charging and leak repairs
                              </h5>
                          </div>
                      </div>
                  </div>
          ...
          <div className="row g-4 p-2 row-cols-sm-3 row-cols-md-4">
            <div className="col-md-4">
              ...
              <p className="footer-brief">
                An application developer’s typical responsibilities include coding, designing,
                application management, troubleshooting, monitoring updates and possible security
          ...
          <div className="row mt-5">
            <div className="col">
              <p className="text-center">
                ...
                by{' '}
                <a href="https://salmank07.github.io/">
