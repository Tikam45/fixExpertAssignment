// src/Linkpp/services/Linkir-conditioner/page.js
        ...
        <section className="intro my-8">
          <div className="container">
            <div className="row">
                ...
                <div className="p-3 p-md-5 custom-bg custom-border-radius">
                  ...
                  <ul className="list-group list-group-flush mt-4">
                    <li className="list-group-item d-flex align-items-center">
                      <span>
                        <Image
                          src="/images/Linklbum/icon-park-solid--check-one.svg"
                          width="24"
                          height="24"
                          className="me-4"
                          alt="tick-icon"
              ...
              <div className="col-md-6">
                <Image
                  src="/images/Linklbum/pngwing.com (1).png"
                  width={100}
                  height={100}
                  alt=""
                />
            ...
            <div className="row g-6">
              <div className="col-6 col-md-3">
                <div className="brand-service">
                  <Link href="/services/Linkir-conditioner/samsung-ac-service-centre">
                    <Image
                      src="/images/Linklbum/brands/bluestar.avif"
                      width={100}
                      height={100}
                ...
                <div className="card h-100">
                  <div className="card-body">
                    <span className="check-mark">
                      <Image
                        src="/images/Linklbum/ion--location-sharp.svg"
                        height="28"
                        width="28"
                        alt="location-icon"
                      />
            ...
            <div className="row mt-5">
              <div className="col">
                <p className="text-center">
                  ...
                  by <Link href="https://salmank07.github.io/">Pixel Crafted Dreams</Link>
                </p>
              </div>
            </div>
          </div>
