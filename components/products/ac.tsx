// src/app/services/air-conditioner/page.js
                ...
                <ul className="navbar-nav ms-auto">
                  ...
                  <li className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a className="dropdown-item" href="/services/fridge">Fridge</a>
                      <a className="dropdown-item" href="/services/dish-washer">Dish Washer</a>
                      <a className="dropdown-item" href="/services/water-heater">Water Heater</a>
                      <a className="dropdown-item" href="/services/oven">Oven</a>
                    </div>
                  </li>
                  <li className="nav-item">
              ...
              <div className="col-md-6">
                <div className="p-3 p-md-5 custom-bg custom-border-radius">
                  ...
                  <h2 className="fw-bold display-5 section-subtitle">
                    <span className="gradient-text">AC</span> Service center
                  </h2>
                  <p>
                    Are you facing issues with your air conditioner? Whether it’s a minor repair,
            ...
            <div className="row g-6">
              <div className="col-6 col-md-3">
                <div className="brand-service">
                  <a href="/services/air-conditioner/samsung-ac-service-centre">
                    <img
          ...
          <div className="container">
            <div className="text-center mb-5">
              ...
              <h2 className="fw-bold display-5 section-subtitle">
                ...
                All Your <span className="gradient-text">Air Conditioning</span> Needs
              </h2>
              <p className="text-custom-light">
                At EasyFix Expert, we offer a full range of professional air conditioning services...
              </p>
            </div>
        ...
        <section className="our-service-includes my-10">
          <div className="container">
            <div className="text-center mb-5">
              ...
              <p className="text-custom-light">
                At srikk service centre, we offer a full range of professional air conditioning services...
              </p>
            </div>
                  ...
                  <div className="card h-100">
                    <div className="card-body">
                      ...
                      <h6 className="card-title">
                        Ac Repair Service Centre in {city}
                      </h6>
                    </div>
                  </div>
                </a>
            ...
            <div className="row mt-5">
              <div className="col">
                <p className="text-center">
                  ...
                  by <a href="https://salmank07.github.io/">Pixel Crafted Dreams</a>
                </p>
              </div>
            </div>
          </div>
