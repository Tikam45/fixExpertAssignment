// src/app/services/fridge/page.js
            ...
            <div className="container-fluid">
              ...
              <div className="collapse navbar-collapse" id="nav-main">
                <ul className="navbar-nav ms-auto">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" aria-current="page" href="/services/air-conditioner">
                      Air Conditioner Service
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="/services/washing-machine">
                      Washing Machine
                    </a>
                  </li>
                  <li className="nav-item dropdown active">
                    ...
                    <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a className="dropdown-item" href="/services/fridge">
                        Fridge
                      </a>
                      <a className="dropdown-item" href="/services/dish-washer">
                        Dish Washer
                      </a>
                      <a className="dropdown-item" href="/services/water-heater">
                        Water Heater
                      </a>
                      <a className="dropdown-item" href="/services/oven">
                        Oven
                      </a>
                    </div>
                  </li>
        ...
        <section className="our-service-includes my-9">
          <div className="container">
            <div className="text-center mb-5">
              ...
              <p className="text-custom-light">
                At EasyFix Expert, we offer a full range of professional refrigerator
                services to ensure your home or business stays cool and comfortable.
                From installation and repairs to routine maintenance, our expert technicians
                are equipped to handle all your refrigerator needs. No matter the brand or
